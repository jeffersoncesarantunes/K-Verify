                            ...
                            const char notes[][MAX_PATH_LEN])
{
    ...
    printf("\n");
    printf("   STATUS:  " CLR_MAGENTA "o Purple Team Validation Complete" CLR_RESET "\n");
    printf("  " CLR_BOLD_YELLOW "========================================" CLR_RESET "\n");
    printf("\n");
}
...
void print_banner(void)
{
    ...
    printf("\n");
    if (geteuid() != 0) {
        printf("  " CLR_BOLD_YELLOW "!" CLR_RESET " " CLR_YELLOW "Not running as root" CLR_RESET " " CLR_YELLOW "-- some tests may fail." CLR_RESET "\n\n");
    }
}
